#include "BrushSquareOutline.h"

BrushSquareOutline::BrushSquareOutline() : BrushSquare() {
	numero_brush = nBrh::SQUARE_OUTLINE;
}

void BrushSquareOutline::carre(float rx, float ry, sf::Image& image) {
