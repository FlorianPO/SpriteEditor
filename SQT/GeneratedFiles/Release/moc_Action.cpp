...
void Action::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Action::*_t)() const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Action::ended)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Action::ended()const
{
    QMetaObject::activate(const_cast< Action *>(this), &staticMetaObject, 0, Q_NULLPTR);
}
