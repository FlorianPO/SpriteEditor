...
QT_MOC_LITERAL(1, 11, 6), // "resize"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 6), // "select"
QT_MOC_LITERAL(4, 26, 8) // "unselect"

    },
    "SpriteView\0resize\0\0select\0unselect"
};
...
const QMetaObject SpriteView::staticMetaObject = {
    { &SQT::staticMetaObject, qt_meta_stringdata_SpriteView.data,
      qt_meta_data_SpriteView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SpriteView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SpriteView.stringdata0))
        return static_cast<void*>(const_cast< SpriteView*>(this));
