/********************************************************************************
** Form generated from reading UI file 'ToolOptionPanel.ui'
**
...
#ifndef UI_TOOLOPTIONPANEL_H
#define UI_TOOLOPTIONPANEL_H
...
public:
    ...
    void setupUi(QWidget *ToolOptionPanel)
    {
        if (ToolOptionPanel->objectName().isEmpty())
            ToolOptionPanel->setObjectName(QStringLiteral("ToolOptionPanel"));
        ToolOptionPanel->resize(129, 161);
        Frame = new QFrame(ToolOptionPanel);
...
"font-weight: bold;"));
        ...
        retranslateUi(ToolOptionPanel);

        Brushes->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(ToolOptionPanel);
    } // setupUi

    void retranslateUi(QWidget *ToolOptionPanel)
    {
        ToolOptionPanel->setWindowTitle(QApplication::translate("ToolOptionPanel", "Form", 0));
        label_opacity->setText(QApplication::translate("ToolOptionPanel", "Opacit\303\251", 0));
        label_seuil->setText(QApplication::translate("ToolOptionPanel", "Seuil", 0));
        Brushes->setTabText(Brushes->indexOf(Default), QApplication::translate("ToolOptionPanel", "Default", 0));
        Brushes->setTabText(Brushes->indexOf(Custom), QApplication::translate("ToolOptionPanel", "Custom", 0));
    } // retranslateUi

};

namespace Ui {
    class ToolOptionPanel: public Ui_ToolOptionPanel {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TOOLOPTIONPANEL_H
